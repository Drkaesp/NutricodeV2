...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, UIManager, Platform, LayoutAnimation } from 'react-native';
                    ...
                    >
                      ...
                      {recipienteAtivo && (
                        <View style={estilos.camadaAbstrataVideoMimica}>
                          {/* // TODO: INTEGRAÇÃO API - Inject Lazy Loaded GIF Frame Here */}
